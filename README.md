# ⚡ Polymarket ETH Auto-Trader

A terminal-based (TUI) auto-trading bot for [Polymarket](https://polymarket.com) **Solana Up or Down — 5 Minutes** markets.
...
- 🎯 **Continuous Auto-Trading** — ETH Up/Down 5-minute windows on Polymarket
...
- ⟠ **Binance Live Ticker** — Sub-second exact ETH price sync (zero on-chain lag)
