"""
Live ETH price feed — reads from Binance WebSocket stream.
...
async def price_feed_loop(state: dict) -> None:
    """
    Continuous loop that keeps state["eth_price"] updated with the latest
    real-time ETH/USDT price from Binance WebSocket.
    """
    log.info("Starting real-time Binance ETH/USDT WebSocket feed...")
